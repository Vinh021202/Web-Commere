          ...
          <div className='productContainer w-[60%] pr-10 pl-10'>
            ...
            <div className='flex items-center gap-3'>
              <span className='text-gray-400 text-[13px]'>Brands : 
                <span className='text-black font-[500] opacity-75'>Flying Machine</span></span>
            ...
            <span className='text-[14px]'>Available In Stock: 
               <span className='text-green-600 font-bold'> 147 Items</span></span>
        </div>
        
        <br />
        <p className='mt-3 pr-10 mb-5'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's 
          ...
          <div className='flex items-center gap-5'>
            ...
            <div className='flex items-center gap-1 actions'>
                <Button className={`${productActionsIndex === 0 ? '!bg-[#ff5252] !text-white': ''}`} 
                onClick={()=>setProductActionsIndex(0)}>S</Button>
                <Button className={`${productActionsIndex === 1 ? '!bg-[#ff5252] !text-white': ''}`}  
                onClick={()=> setProductActionsIndex(1)}>M</Button>
                <Button className={`${productActionsIndex === 2 ? '!bg-[#ff5252] !text-white': ''}`} 
                onClick={()=> setProductActionsIndex(2)}>L</Button>
                <Button className={`${productActionsIndex === 3 ? '!bg-[#ff5252] !text-white': ''}`} 
                onClick={()=> setProductActionsIndex(3)}>XL</Button>
            </div>
          </div>
          <p className='text-[14px] mb-2 mt-5 !text-[#000]'>Free Shipping (Est. Delivery Time 2-3 Days)</p>
        ...
        <tbody>
            <tr class="bg-white border-b  border-gray-200">
                ...
                <td class="px-6 py-4 font-[500]">
                    35"Lx24"Wx37-45"H(font to back wheel)
                </td>
                <td class="px-6 py-4 font-[500]">
                      32.5"Lx18.5"Wx16.5"H
                </td>
                <td class="px-6 py-4 font-[500]">
                    32.5"Lx24"Wx18.5"H
                </td>
