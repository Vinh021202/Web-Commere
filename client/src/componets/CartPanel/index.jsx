     ...
     <div className='scroll w-full max-h-[350px] overflow-y-scroll overflow-x-hidden py-3 px-4'>
            <div className='cartItem w-full flex items-center gap-4 border-b border-[rgba(0,0,0,0.1)] pb-4'>
                    ...
                    <div className='info w-[75%] pr-5 relative'>
                      ...
                      Women Wide Leg High-Rise Light Fade Stretchable Jeans </Link></h4>
                      <p className='flex items-center gap-5 mt-2 mb-2'>Qty : <span>2</span>
                      <span className='text-primary font-bold'>Price : $25</span></p>
            ...
            <div className='bottomInfo py-3 px-4 w-full border-t border-[rgba(0,0,0,0.1)] flex items-center 
            ...
            <div className='flex items-center justify-between w-full gap-5 px-3 py-3'>
               <Link to="/cart" className='w-[50%] d-block'><Button className='bg-org btn-lg w-full'>View Cart</Button></Link>
                <Link to="/checkout" className='w-[50%] d-block'><Button className='bg-org btn-lg w-full'>Checkout</Button></Link>
            </div>
        </div>
    </>
  )
