      ...
      <div className='box'>
        ...
        <Collapse isOpened={isopenCategoryFilter}>
          <div className='scroll px-4 relative -left-[13px]'>
            ...
            <FormControlLabel control={<Checkbox defaultChecked size="small"/>} label="Elctronics" className='w-full'/>
       ...
       <div className='box'>
        ...
        <Collapse isOpened={isopenAvilFilter}>
          <div className='scroll px-4 relative -left-[13px]'>
            ...
            <FormControlLabel control={<Checkbox defaultChecked size="small"/>} label="Not available (1)" className='w-full' />
        ...
        <Collapse isOpened={isopenSizeFilter}>
          <div className='scroll px-4 relative -left-[13px]'>
            <FormControlLabel control={<Checkbox defaultChecked size="small"/>} label="Samll (6)" className='w-full' />
            <FormControlLabel control={<Checkbox defaultChecked size="small"/>} label="Medium (5)" className='w-full' />
            <FormControlLabel control={<Checkbox defaultChecked size="small"/>} label="Large (4)" className='w-full' />
            <FormControlLabel control={<Checkbox defaultChecked size="small"/>} label="XL (1)" className='w-full' />
            <FormControlLabel control={<Checkbox defaultChecked size="small"/>} label="XLL (3)" className='w-full' />
