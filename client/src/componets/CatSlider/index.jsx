      ...
      >
        <SwiperSlide>
            ...
            <div className='item py-7 px-3 bg-white rounded-sm text-center flex items-center justify-center flex-col '>
                <img src='/navImg/fashion.jpg'  alt='fashion' className='w-[60px] transition-all'/>
        ...
        <SwiperSlide>
            <Link to={"/"}>
            <div className='item py-7 px-3 bg-white rounded-sm text-center flex items-center justify-center flex-col '>
                <img src='/navImg/Elctronics.png'  alt='Elctronics' className='w-[60px] transition-all'/>
        ...
        <SwiperSlide>
            <Link to={"/"}>
            <div className='item py-7 px-3 bg-white rounded-sm text-center flex items-center justify-center flex-col '>
                <img src='/navImg/Footwear.svg'  alt='Footwear.svg' className='w-[60px] transition-all'/>
        ...
        <SwiperSlide>
            <Link to={"/"}>
            <div className='item py-7 px-3 bg-white rounded-sm text-center flex items-center justify-center flex-col '>
                <img src='/navImg/Groceries.png'  alt='Groceries' className='w-[60px] transition-all'/>
        ...
        <SwiperSlide>
            <Link to={"/"}>
            <div className='item py-7 px-3 bg-white rounded-sm text-center flex items-center justify-center flex-col '>
                <img src='/navImg/Wellness1.jpg'  alt='Wellness' className='w-[60px] transition-all'/>
        ...
        <SwiperSlide>
            <Link to={"/"}>
            <div className='item py-7 px-3 bg-white rounded-sm text-center flex items-center justify-center flex-col '>
                <img src='/navImg/Jewellery.jpg'  alt='Jewellery' className='w-[60px] transition-all'/>
