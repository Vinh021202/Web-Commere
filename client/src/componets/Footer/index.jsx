        ...
        <div className='container'>
            <div className='flex items-center justify-center gap-2 py-8 pb-8'>
                <div className='col flex items-center justify-center flex-col group w-[15%]'>
                    <LiaShippingFastSolid className='text-[40px] transition-all 
                 ...
                 <div className='col flex items-center justify-center flex-col group w-[15%]'>
                    <PiKeyReturn  className='text-[40px] transition-all 
                    duration-300 group-hover:text-[#ff5252] group-hover:-translate-y-1' />
                 ...
                 <div className='col flex items-center justify-center flex-col group w-[15%]'>
                    <BsWallet2 className='text-[40px] transition-all 
                    duration-300 group-hover:text-[#ff5252] group-hover:-translate-y-1' />
                 ...
                 <div className='col flex items-center justify-center flex-col group w-[15%]'>
                    <LiaGiftSolid className='text-[40px] transition-all 
                    duration-300 group-hover:text-[#ff5252] group-hover:-translate-y-1' />
            ...
            <div className='footer flex  py-8'>
                <div className='part1 w-[25%] border-r border-[rgba(0,0,0,0.1)]'>
                    ...
                    <p className='text-[13px] font-[400] pb-4'>ECommerce-Shoping - Mega Super Store <br/> 507 -Union Trade Centre Việt Name  </p>
                    <Link className='link' to={"mailto:someone@example.com"}>quocvinhtran.0212@gmail.com</Link>
                    <span className='text-[25px] font-[600] block w-full mt-3 mb-5 text-primary'>(+84) 9465-65-316</span>  

                    <div className='flex items-center gap-2'>
                        <MdChatBubbleOutline className='text-[40px] text-primary'/>
                        <span className='text-[17px] font-[600]'> Online Chat <br/> Get Expert Help</span>
                    </div>
                </div>
                   ...
                   <div className='part2_col1 w-[50%]'>
                     ...
                     <ul className='list'>
                        <li className='list-none text-[14px] w-full mb-2'>
                            <Link to={"/"} className='link'>Prices drop
                            </Link>
                        </li>
                        <li className='list-none text-[14px] w-full mb-2'>
                            <Link to={"/"} className='link'>New Products
                            </Link>
                        </li>
                        <li className='list-none text-[14px] w-full mb-2'>
                            <Link to={"/"} className='link'>Bet Sales
                            </Link>
                        </li>
                        <li className='list-none text-[14px] w-full mb-2'>
                            <Link to={"/"} className='link'>Contact Us
                            </Link>
                        </li>
                        <li className='list-none text-[14px] w-full mb-2'>
                            <Link to={"/"} className='link'>Sitemap
                            </Link>
                        </li>
                        <li className='list-none text-[14px] w-full mb-2'>
                            <Link to={"/"} className='link'>Stores
                            </Link>
                        </li>
                     </ul>
                   </div>
                     ...
                     <ul className='list'>
                        <li className='list-none text-[14px] w-full mb-2'>
                            <Link to={"/"} className='link'>Delivery
                            </Link>
                        </li>
                        <li className='list-none text-[14px] w-full mb-2'>
                            <Link to={"/"} className='link'>Legal Notice
                            </Link>
                        </li>
                        <li className='list-none text-[14px] w-full mb-2'>
                            <Link to={"/"} className='link'>Terms And Conditions Of Use
                            </Link>
                        </li>
                        <li className='list-none text-[14px] w-full mb-2'>
                            <Link to={"/"} className='link'>About Us
                            </Link>
                        </li>
                        <li className='list-none text-[14px] w-full mb-2'>
                            <Link to={"/"} className='link'>SecurePayment
                            </Link>
                        </li>
                        <li className='list-none text-[14px] w-full mb-2'>
            ...
            <ul className='flex items-center gap-2'>
                <li className='list-none'>
                 ...
                 flex items-center justify-center group hover:bg-[#ff5252] transition-all">
                        <FaFacebookF  className="text-[15px] group-hover:text-white"/></Link>
                </li>
                ...
                <li className='list-none'>
                    <Link to={"/"} target='_blank' 
                      className="w-[35px] h-[35px] rounded-full border border-[rgba(0,0,0,0.1)] 
                 flex items-center justify-center group hover:bg-[#ff5252] transition-all">
                        <AiOutlineYoutube  className="text-[15px] group-hover:text-white"/></Link>
                </li>
                ...
                <li className='list-none'>
                    <Link to={"/"} target='_blank' 
                      className="w-[35px] h-[35px] rounded-full border border-[rgba(0,0,0,0.1)] 
                 flex items-center justify-center group hover:bg-[#ff5252] transition-all">
                        <FaInstagram  className="text-[15px] group-hover:text-white"/></Link>
                </li>
