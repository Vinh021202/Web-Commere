        ...
        <div className='container flex items-center justify-between gap-5'>
            <div className='col_1 w-[20%]'>
                <Button className='!text-black gap-2 w-full ' onClick={openCategoryPanel}>
                    <RiMenu2Fill size={18}  />SHOP BY CATEGORYTAB
             ...
             <div className='col_2 w-[60%]'>
                <ul className='flex items-center gap-3 nav'>
                    <li className='list-none'>
                        <Link to={"/"} className='link transform text-[14px] font-[500]'>
                    ...
                    <li className='list-none relative'>
                        <Link to={"/ProductListing"} className='link transform text-[14px] font-[500]'>
                         <Button className='link transition !font-[500] !text-[rgba(0,0,0,0.8)] hover:!text-[#ff5252] !py-4'>
                        Fashion</Button></Link>
                    ...
                    <li className='list-none'>
                        <Link to={"/"} className='link transform text-[14px] font-[500]'>
                         <Button className='link transition !font-[500] !text-[rgba(0,0,0,0.8)] hover:!text-[#ff5252] !py-4'>
                        Jewellery</Button></Link>
                    </li>
                </ul>
            </div>
             <div className='col_3 w-[20%]'>
                <span className='text-[14px] !font-[500] flex items-center gap-3 ml-0 mt-0'> <GoRocket size={18} /> Free International Delivery</span>
            </div>
        </div>
    </nav>

    {/*Category Panel components */}
    <CategoryPanel  isopenCategoryPanel={isopenCategoryPanel} 
