              ...
              <li className='list-none flex items-center relative flex-col'>
                  ...
                  )}
                {
                  ...
                  innerSubmenuIndex === 0 ? (
                    ...
                    <li className='list-none relative'>
                        <Link to={"/"} className='link w-full !text-left !justify-start !px-3 transition text-[14px] mb-1'>Smart Tablet </Link>                                          
                    </li>
                     <li className='list-none relative'>
                        <Link to={"/"} className='link w-full !text-left !justify-start !px-3 transition text-[14px] mb-1'>Crepe T-Shirt </Link>
                                           
                    </li> <li className='list-none relative'>
                        <Link to={"/"} className='link w-full !text-left !justify-start !px-3 transition text-[14px] mb-1'>Leather Watch </Link>
                                           
                    </li> <li className='list-none relative'>
                        <Link to={"/"} className='link w-full !text-left !justify-start !px-3 transition text-[14px] mb-1'>Rolling Diamond </Link>
