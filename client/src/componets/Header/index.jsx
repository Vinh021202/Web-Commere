  ...
  return (
    <>
        <header className='bg-white'>
                        ...
                        <div className='col2 flex items-center justify-end'>
                            <ul className='flex items-center gap-3'>
                                <li className='list-none'>
                                 ...
                                 <li className='list-none'>
                                    <Link to="/order-tracking" className='text-[13px] link font-[500] transform'>Order Tracking</Link>
                                </li>
                                 {/* <li className='list-none'>
                                    <Link to="help-center" className='text-[13px] link font-[500] transform'>Help Center</Link>
                                </li>
          ...
          <div className='logo'>
              <Link to={"/"}><img src="/logo1.jpg" alt="logo" className="w-[220px] h-[85px]" /></Link>
          </div>
          <Search />
