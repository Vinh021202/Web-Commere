              ...
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div className="max-w-[620px]">
                  ...
                  <p className="mt-2 text-[13px] leading-6 text-slate-600">
                    Create a category with a name and cover image. The layout is
                    kept compact so it stays comfortable on laptop screens.
                  </p>
                </div>
              ...
              <div className="rounded-[22px] border border-[#edf1f7] bg-[#fbfcff] p-4">
                ...
                <div className="mt-4 rounded-[18px] bg-white p-4 shadow-[0_8px_24px_rgba(15,23,42,0.04)]">
                  ...
                  <ul className="mt-3 space-y-2 text-[13px] leading-6 text-slate-500">
                    <li>Use short and clear names for storefront navigation.</li>
                    <li>Upload at least one image for visual consistency.</li>
                    <li>Changes will appear in the category list right away.</li>
                  </ul>
                </div>
              </div>
