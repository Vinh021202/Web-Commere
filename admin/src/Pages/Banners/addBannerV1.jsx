            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-[14px] text-slate-500">
                  Create a new storefront banner with category targeting.
                </p>
              </div>
            </div>
          ...
          <div className="grid gap-5 xl:grid-cols-[1.3fr_0.9fr]">
            <div className="rounded-[24px] border border-[#edf2f8] bg-[#fbfcff] p-5 shadow-[0_10px_30px_rgba(15,23,42,0.04)]">
              <div className="mb-5">
                ...
                <p className="mt-2 text-[13px] text-slate-500">
                  Fill in banner text, price, placement and matching categories.
                </p>
              </div>
            ...
            <div className="rounded-[24px] border border-[#edf2f8] bg-[#fbfcff] p-5 shadow-[0_10px_30px_rgba(15,23,42,0.04)]">
              <div className="mb-4">
                ...
                <p className="mt-2 text-[13px] text-slate-500">
                  Upload banner images to preview how they will appear.
                </p>
              </div>
