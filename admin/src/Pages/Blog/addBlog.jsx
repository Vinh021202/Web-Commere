            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="mt-2 text-[14px] text-slate-500">
                  Write a new blog article with cover images and rich content.
                </p>
              </div>
            </div>
          ...
          <div className="grid gap-5 xl:grid-cols-[1.25fr_0.95fr]">
            <div className="rounded-[24px] border border-[#edf2f8] bg-[#fbfcff] p-5 shadow-[0_10px_30px_rgba(15,23,42,0.04)]">
              <div className="mb-5">
                ...
                <p className="mt-2 text-[13px] text-slate-500">
                  Add a clear title and compose the article content below.
                </p>
              </div>
            ...
            <div className="rounded-[24px] border border-[#edf2f8] bg-[#fbfcff] p-5 shadow-[0_10px_30px_rgba(15,23,42,0.04)]">
              <div className="mb-4">
                ...
                <p className="mt-2 text-[13px] text-slate-500">
                  Upload article thumbnails or supporting images for the post.
                </p>
              </div>
